            ...
            <nav className="navbar navbar-expand-lg bg-body-tertiary">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <li className={`nav-item ${location.pathname === '/Inicio' ? 'active' : ''}`}>
                            <Link className="nav-link" to="/Inicio">Inicio</Link>
                        </li>
                        <li className={`nav-item ${location.pathname === '/Facturas' ? 'active' : ''}`}>
                            <Link className="nav-link" to="/Facturas">Facturas</Link>
                        </li>
                        <li className={`nav-item ${location.pathname === '/Optimizadores' ? 'active' : ''}`}>
                            <Link className="nav-link" to="/Optimizadores">Optimizadores</Link>
                        </li>
                        <li className={`nav-item ${location.pathname === '/control-horario' ? 'active' : ''}`}>
                            <Link className="nav-link" to="/control-horario">Control de Horario</Link>
                        </li>
                        <li className={`nav-item ${location.pathname === '/historial-cambios' ? 'active' : ''}`}>
                            <Link className="nav-link" to="/historial-cambios">H.cambios</Link>
                        </li>
                            <li className="nav-item">
                                <OverlayTrigger trigger="click" placement="bottom" overlay={popoverBottom}>
                                    <button className="btn nav-link Bell" onClick={handlePopoverClick} 
                                    aria-label="Boton de alertas de servicios" >
                                        {showPopover ? (
                                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                          fill="currentColor" className="bi bi-bell-fill" viewBox="0 0 16 16">
                                          <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2m.995-14.901a1 1 0 1 0-1.99 
                                          0A5 5 0 0 0 3 6c0 
                                          1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901"/>
                                            </svg>
                            ...
                            aria-label="Boton de perfil">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                            fill="currentColor" className="bi bi-person-circle me-2" viewBox="0 0 16 16">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                                <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 
                                1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 
                        ...
                        <li className="nav-item ">
                            ...
                            aria-label="Boton de cierre de sesión">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" 
                                className="bi bi-box-arrow-right" viewBox="0 0 16 16">
                                    <path fillRule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 
                                    0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 
                                    0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z"/>
                                    <path fillRule="evenodd" d="M15.854 8.354a.5.5 0 0 0 
